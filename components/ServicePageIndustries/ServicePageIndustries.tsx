  ...
  return (
    <div className="p-3">
      <div className="text-center inter-font mt-5">
        ...
        <Link className="rounded-lg p-3 text-white bg-blue-600 bg-opacity-80 md:bg-opacity-60 no-underline hover:underline-offset-4 hover:underline hover:bg-opacity-100 transition duration-200 px-5" href="/industries" >{componentData.buttonText}</Link>
      </div>
