...
export default function ServiceSectorPageServices({componentData}: ServiceSectorPageServicesProps) {
  return (
    <div className="p-5">
      ...
      <img className='md:max-w-[900px] m-auto' src={componentData.image.data.attributes.url} alt={componentData.image.data.attributes.alternativeText} title={componentData.image.data.attributes.caption} />
